  ...
  template: `
    <section class="overview-page__banner" aria-label="overview page banner">
      <svg xmlns="http://www.w3.org/2000/svg" class="banner__background" viewBox="0 0 1530 823">
        ...
        <g fill="none" stroke="#00a0df" stroke-width="2">
          <path
      ...
      <h1 class="banner__title"><span class="banner__logo--bold">Frequence UI Kit</span></h1>
      <h2 class="banner__subtitle">An Angular Component Library</h2>
    </section>
  `,
