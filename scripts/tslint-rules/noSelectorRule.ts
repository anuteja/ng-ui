...
import { getDecoratorArgument, getDecoratorPropertyInitializer } from 'codelyzer/util/utils';
...
class Walker extends NgWalker {
  ...
  protected visitNgComponent(metadata: ComponentMetadata): void {
    ...
    const properties = ts.createNodeArray<ts.PropertyAssignment>(args.properties as ReadonlyArray<
